...
public:
 Stratum_add_ed981d530a6b23bd(SymbolTable& symTable,RecordTable& recordTable,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_iii__0_1_2__100__110__111::Type& rel_delta_add_241d705dc2fb23df,t_eqrel& rel_delta_eql_fdc75db4daac3372,t_btree_ii__0_1__11__10::Type& rel_delta_leader_d4159f531d436f83,t_btree_iii__0_1_2__100__110__111::Type& rel_new_add_954a8c50e586f068,t_eqrel& rel_new_eql_10ebb01129546352,t_btree_ii__0_1__11__10::Type& rel_new_leader_99e6be51e44547e4,t_btree_iii__0_1_2__100__110__111::Type& rel_add_48c57da858454f79,t_btree_iii__0_1_2__111::Type& rel_add_prep_e8dfec160429ed9e,t_eqrel& rel_eql_e1be027843ac9bc5,t_btree_ii__0_1__11__10::Type& rel_leader_d565398e1ef92697,t_btree_ii__0_1__11__10::Type& rel_var_09870be8e1a4a08e);
void run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret);
private:
SymbolTable& symTable;
RecordTable& recordTable;
...
t_btree_ii__0_1__11__10::Type* rel_new_leader_99e6be51e44547e4;
...
t_btree_ii__0_1__11__10::Type* rel_leader_d565398e1ef92697;
...
signalHandler->setMsg(R"_(add(x,y,c) :- 
   add_prep(x,y,c).
in file leader.dl [21:1-21:35])_");
...
signalHandler->setMsg(R"_(eql(x,x) :- 
   var(_,x).
in file leader.dl [24:1-24:24])_");
...
signalHandler->setMsg(R"_(eql(c1,c2) :- 
   ...
   var(x,c2),
   c1 != c2.
in file leader.dl [29:1-29:49])_");
if(!(rel_var_09870be8e1a4a08e->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_eql_e1be027843ac9bc5_op_ctxt,rel_eql_e1be027843ac9bc5->createContext());
CREATE_OP_CONTEXT(rel_var_09870be8e1a4a08e_op_ctxt,rel_var_09870be8e1a4a08e->createContext());
...
signalHandler->setMsg(R"_(add(x1,y1,c1) :- 
   ...
   leader(y,y1),
   leader(c,c1).
in file leader.dl [32:1-32:78])_");
...
signalHandler->setMsg(R"_(add(x,y,$Add(x, y)) :- 
   add(y,x,_).
in file leader.dl [36:1-40:18])_");
...
signalHandler->setMsg(R"_(add(x,$Add(y, z),$Add(x, $Add(y, z))) :- 
   add(x,y,xy),
   add(xy,z,_).
in file leader.dl [43:1-48:38])_");
...
signalHandler->setMsg(R"_(eql(x,x) :- 
   add(_,_,x).
in file leader.dl [25:1-25:27])_");
if(!(rel_delta_add_241d705dc2fb23df->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_delta_add_241d705dc2fb23df_op_ctxt,rel_delta_add_241d705dc2fb23df->createContext());
...
signalHandler->setMsg(R"_(eql(c1,c2) :- 
   ...
   add(x,y,c2),
   c1 != c2.
in file leader.dl [28:1-28:55])_");
if(!(rel_delta_add_241d705dc2fb23df->empty()) && !(rel_add_48c57da858454f79->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_delta_add_241d705dc2fb23df_op_ctxt,rel_delta_add_241d705dc2fb23df->createContext());
CREATE_OP_CONTEXT(rel_new_eql_10ebb01129546352_op_ctxt,rel_new_eql_10ebb01129546352->createContext());
...
in file leader.dl [51:1-51:83])_");
...
();}
if(rel_new_add_954a8c50e586f068->empty() && rel_new_eql_10ebb01129546352->empty() && rel_new_leader_99e6be51e44547e4->empty()) break;
[&](){
CREATE_OP_CONTEXT(rel_new_add_954a8c50e586f068_op_ctxt,rel_new_add_954a8c50e586f068->createContext());
CREATE_OP_CONTEXT(rel_add_48c57da858454f79_op_ctxt,rel_add_48c57da858454f79->createContext());
...
();std::swap(rel_delta_leader_d4159f531d436f83, rel_new_leader_99e6be51e44547e4);
...
rel_new_leader_99e6be51e44547e4->purge();
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty\tc"},{"auxArity","0"},{"name","add"},{"operation","output"},{"output-dir","leader"},{"params","{\"records\": {}, \"relation\": {\"arity\": 3, \"params\": [\"x\", \"y\", \"c\"]}}"},{"types","{\"ADTs\": {\"+:Id\": {\"arity\": 2, \"branches\": [{\"name\": \"Add\", \"types\": [\"+:Id\", \"+:Id\"]}, {\"name\": \"Var\", \"types\": [\"i:number\"]}], \"enum\": false}}, \"records\": {}, \"relation\": {\"arity\": 3, \"types\": [\"+:Id\", \"+:Id\", \"+:Id\"]}}"}});
...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","a\tb"},{"auxArity","0"},{"name","leader"},{"operation","output"},{"output-dir","leader"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"a\", \"b\"]}}"},{"types","{\"ADTs\": {\"+:Id\": {\"arity\": 2, \"branches\": [{\"name\": \"Add\", \"types\": [\"+:Id\", \"+:Id\"]}, {\"name\": \"Var\", \"types\": [\"i:number\"]}], \"enum\": false}}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"+:Id\", \"+:Id\"]}}"}});
if (!outputDirectory.empty()) {directiveMap["output-dir"] = outputDirectory;}
...
in file leader.dl [14:1-14:52])_");
[&](){
CREATE_OP_CONTEXT(rel_add_prep_e8dfec160429ed9e_op_ctxt,rel_add_prep_e8dfec160429ed9e->createContext());
...
signalHandler->setMsg(R"_(add_prep($Var((x+1)),id,$Add($Var((x+1)), id)) :- 
   ...
   x <= n,
   N(n).
in file leader.dl [15:1-19:15])_");
...
signalHandler->setMsg(R"_(class(@generator_0) :- 
   eql(a,a),
   @generator_0 = min as(b0, number) : { eql(a,b0),as(b0, number) = as(b0, number) }.
in file leader.dl [54:1-54:71])_");
...
();}
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","a"},{"auxArity","0"},{"name","class"},{"operation","output"},{"output-dir","leader"},{"params","{\"records\": {}, \"relation\": {\"arity\": 1, \"params\": [\"a\"]}}"},{"types","{\"ADTs\": {\"+:Id\": {\"arity\": 2, \"branches\": [{\"name\": \"Add\", \"types\": [\"+:Id\", \"+:Id\"]}, {\"name\": \"Var\", \"types\": [\"i:number\"]}], \"enum\": false}}, \"records\": {}, \"relation\": {\"arity\": 1, \"types\": [\"+:Id\"]}}"}});
if (!outputDirectory.empty()) {directiveMap["output-dir"] = outputDirectory;}
...
public:
 Stratum_root_83915ac4426ff1c9(SymbolTable& symTable,RecordTable& recordTable,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_iii__0_1_2__100__110__111::Type& rel_add_48c57da858454f79,t_btree_ii__0_1__11__10::Type& rel_leader_d565398e1ef92697,t_btree_ii__0_1__11::Type& rel_root_4971aadef59ffd68,t_btree_ii__0_1__11__10::Type& rel_var_09870be8e1a4a08e);
void run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret);
private:
SymbolTable& symTable;
RecordTable& recordTable;
...
signalHandler->setMsg(R"_(root(1,lx1234) :- 
   ...
   add(lx123,lx4,x1234),
   leader(x1234,lx1234).
in file leader.dl [58:1-65:51])_");
...
signalHandler->setMsg(R"_(root(2,lx4321) :- 
   ...
   add(lx432,lx1,x4321),
   leader(x4321,lx4321).
in file leader.dl [68:1-75:51])_");
if(!(rel_add_48c57da858454f79->empty()) && !(rel_var_09870be8e1a4a08e->empty()) && !(rel_leader_d565398e1ef92697->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_add_48c57da858454f79_op_ctxt,rel_add_48c57da858454f79->createContext());
CREATE_OP_CONTEXT(rel_leader_d565398e1ef92697_op_ctxt,rel_leader_d565398e1ef92697->createContext());
...
();}
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","i\ta"},{"auxArity","0"},{"name","root"},{"operation","output"},{"output-dir","leader"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"i\", \"a\"]}}"},{"types","{\"ADTs\": {\"+:Id\": {\"arity\": 2, \"branches\": [{\"name\": \"Add\", \"types\": [\"+:Id\", \"+:Id\"]}, {\"name\": \"Var\", \"types\": [\"i:number\"]}], \"enum\": false}}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"+:Id\"]}}"}});
if (!outputDirectory.empty()) {directiveMap["output-dir"] = outputDirectory;}
...
in file leader.dl [12:1-12:17])_");
[&](){
CREATE_OP_CONTEXT(rel_var_09870be8e1a4a08e_op_ctxt,rel_var_09870be8e1a4a08e->createContext());
...
in file leader.dl [13:1-13:17])_");
[&](){
CREATE_OP_CONTEXT(rel_var_09870be8e1a4a08e_op_ctxt,rel_var_09870be8e1a4a08e->createContext());
...
namespace souffle {
class Sf_leader: public SouffleProgram {
public:
 Sf_leader();
 ~Sf_leader();
void run();
...
Own<t_btree_ii__0_1__11__10::Type> rel_leader_d565398e1ef92697;
souffle::RelationWrapper<t_btree_ii__0_1__11__10::Type> wrapper_rel_leader_d565398e1ef92697;
Own<t_btree_ii__0_1__11__10::Type> rel_delta_leader_d4159f531d436f83;
Own<t_btree_ii__0_1__11__10::Type> rel_new_leader_99e6be51e44547e4;
...
rel_leader_d565398e1ef92697(mk<t_btree_ii__0_1__11__10::Type>()),
...
rel_new_leader_99e6be51e44547e4(mk<t_btree_ii__0_1__11__10::Type>()),
...
stratum_add_14722fa4ca06c6d9(symTable,recordTable,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_delta_add_241d705dc2fb23df,*rel_delta_eql_fdc75db4daac3372,*rel_delta_leader_d4159f531d436f83,*rel_new_add_954a8c50e586f068,*rel_new_eql_10ebb01129546352,*rel_new_leader_99e6be51e44547e4,*rel_add_48c57da858454f79,*rel_add_prep_e8dfec160429ed9e,*rel_eql_e1be027843ac9bc5,*rel_leader_d565398e1ef92697,*rel_var_09870be8e1a4a08e),
...
void Sf_leader::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf_leader::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf_leader::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","a\tb"},{"auxArity","0"},{"name","leader"},{"operation","output"},{"output-dir","leader"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"a\", \"b\"]}}"},{"types","{\"ADTs\": {\"+:Id\": {\"arity\": 2, \"branches\": [{\"name\": \"Add\", \"types\": [\"+:Id\", \"+:Id\"]}, {\"name\": \"Var\", \"types\": [\"i:number\"]}], \"enum\": false}}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"+:Id\", \"+:Id\"]}}"}});
...
void Sf_leader::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","n"},{"auxArity","0"},{"fact-dir","."},{"filename","N.in"},{"name","N"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 1, \"params\": [\"n\"]}}"},{"types","{\"ADTs\": {\"+:Id\": {\"arity\": 2, \"branches\": [{\"name\": \"Add\", \"types\": [\"+:Id\", \"+:Id\"]}, {\"name\": \"Var\", \"types\": [\"i:number\"]}], \"enum\": false}}, \"records\": {}, \"relation\": {\"arity\": 1, \"types\": [\"i:number\"]}}"}});
...
SymbolTable& Sf_leader::getSymbolTable(){
return symTable;
}

RecordTable& Sf_leader::getRecordTable(){
return recordTable;
}

void Sf_leader::setNumThreads(std::size_t numThreadsValue){
SouffleProgram::setNumThreads(numThreadsValue);
symTable.setNumLanes(getNumThreads());
recordTable.setNumLanes(getNumThreads());
}

void Sf_leader::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
if (name == "N") {
stratum_N_f2fd84e3ee54ddcf.run(args, ret);
return;}
if (name == "add") {
...
namespace souffle {
SouffleProgram *newInstance_leader(){return new Sf_leader;}
SymbolTable *getST_leader(SouffleProgram *p){return &reinterpret_cast<Sf_leader*>(p)->getSymbolTable();}
} // namespace souffle
...
{
try{
souffle::CmdOptions opt(R"(leader.dl)",
R"()",
R"()",
false,
R"()",
...
namespace souffle {
class factory_Sf_leader: souffle::ProgramFactory {
public:
...
namespace souffle {
SouffleProgram* factory_Sf_leader::newInstance(){
return new Sf_leader();
}

 factory_Sf_leader::factory_Sf_leader():
ProgramFactory("leader"){
}
...
extern "C" {
factory_Sf_leader __factory_Sf_leader_instance;
}
#endif
} // namespace souffle
